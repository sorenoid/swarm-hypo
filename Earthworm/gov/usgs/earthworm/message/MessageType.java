...
//  TYPE_CODA2(13),			// coda info from picker & pick_ew
    ...
    TYPE_H71SUM2K(15),		// hypo71-format hypocenter summary msg (with 4-digit year) from eqproc/eqprelim
...
//  TYPE_H71SUM(18),		// hypo71-format summary msg from eqproc/eqprelim
    TYPE_TRACEBUF2(19),		// single-channel waveforms from NT adsend, getdst2, nano2trace, rcv_ew, import_ida...
    TYPE_TRACEBUF(20),		// single-channel waveforms from NT adsend, getdst2, nano2trace, rcv_ew, import_ida...
...
//  TYPE_TRIGLIST(24),		// trigger-list msg (used by tracesave modules) from arc2trig, trg_assoc, carlsubtrig
    TYPE_TRIGLIST2K(25),	// trigger-list msg (with 4-digit year) used  by tracesave modules from arc2trig, trg_assoc, carlsubtrig
    TYPE_TRACE_COMP_UA(26),	// compressed waveforms from compress_UA
    TYPE_STRONGMOTION(27),	// single-instrument peak accel, peak velocity, peak displacement, spectral acceleration 
