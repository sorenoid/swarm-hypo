...
FormLayout layout = new FormLayout(
		...
		builder.addLabel("P - S Time :","1,5,1,1,FILL,FILL");
		builder.add(pToSTimeValue,"3,5,1,1,FILL,FILL");
		
		pToSdistanceValue = new JLabel();
		builder.addLabel("P - S Distance :","1,7,1,1,FILL,FILL");
	 ...
	 * @param value : Time value of p to s markers
	 */
	 ...
	 * @param value : Distance value of p to s markers
	 */
