...
public class Marker implements Serializable {
	...
	/**
	 * Gets all {@link Marker} objects related to a specifed Attempt from the
	 * database
	 * 
	 * @param id
	...
	public static List<Marker> listByAttempt(Integer id) {
		return entityManager()
				.createQuery("SELECT o FROM Marker o where o.attempt = :id",
						Marker.class).setParameter("id", id).getResultList();
	}

	/**
	 * Gets all {@link Marker} objects of a particular type associated with a
	 * particular Attempt and station <br />
	 ...
	 * @return
	 */
	public static List<Marker> listByStationAndTypeAndAttempt(Integer id,
			String station, String markerType) {
		return entityManager()
				.createQuery(
						"SELECT o FROM Marker o where o.attempt = :id and o.station = :station and o.markerType = :markerType",
						Marker.class).setParameter("id", id)
	...
	public static List<String> listStationByAttempt(Integer id) {
		return entityManager()
				.createQuery(
						"SELECT o.station FROM Marker o where o.attempt = :id group by o.station",
						String.class).setParameter("id", id).getResultList();
	}

	/**
	 * Gets all filePaths/fileTypes for wave files that is associated with a
	 * specified Attempt
	 * 
	 * 
	 * @param id
	...
	public static List<Object[]> listMarkerByAttempt(Integer id) {
		return entityManager()
				.createQuery(
						"SELECT o.filePath, o.fileType FROM Marker o where o.attempt = :id group by o.filePath",
						Object[].class).setParameter("id", id).getResultList();
	}

	/**
	 * 
	 * Gets all {@link Marker} objects associated with a specified channel
	 * index, wavefile and attempt
	 * 
	 * @param fileIndex
	 ...
	 * @return
	 */
	public static List<Marker> listByFileAndIndexAndAttempt(Integer fileIndex,
			String filePath, Integer id) {
		return entityManager()
				.createQuery(
	...
	/**
	 * Gets all {@link Attempt} objects that contains P-markers(associated with
	 * a specified event, start and end time within wave frame if specified)
	 * 
	 * 
	 * @param eventType
	 *            : Event type
	 ...
	 * @return
	 */
	public static List<Attempt> getAttemptsByPMarker(String eventType,
			Timestamp fromTime, Timestamp endTime) {
		...
		TypedQuery<Object[]> attemptQuery = entityManager().createQuery(
	...
	/**
	 * Gets all {@link Attempt} Objects that contains P markers with specified
	 * location and depth within a specified depth range
	 * 
	 * 
	 * @param minDepth
	 ...
	 * @param longLat
	 *            : Specified Location information(included longitude and
	 *            latitude information)
	 * @return
	 */
	public static List<Attempt> getAttemptsByPMarkerAndLocationAndDepth(
			Double minDepth, Double maxDepth, Point2D.Double longLat) {
		StringBuilder sb = new StringBuilder();
		sb.append("SELECT o, a, e  FROM Marker as o, Attempt as a, Event as e where o.markerType =:markerType  and o.attempt = a.id and a.event = e.id ");
		if (minDepth != null) {
