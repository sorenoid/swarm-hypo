...
public class XMLElement implements IXMLElement, Serializable {
     ...
     * The child elements.
     */
    private Vector<IXMLElement> children;
    ...
    public XMLElement(String fullName,
        ...
        this.children = new Vector<IXMLElement>(8);
    ...
    public IXMLElement getFirstChildNamed(String name) {
        ...
        while (enum1.hasMoreElements()) {
            IXMLElement child = (IXMLElement) enum1.nextElement();
    ...
    private XMLAttribute findAttribute(String fullName) {
        Enumeration enum1 = this.attributes.elements();
        while (enum1.hasMoreElements()) {
            XMLAttribute attr = (XMLAttribute) enum1.nextElement();
    ...
    public IXMLElement get(String key)
    {
    	...
    	{
    		elt = elt.getFirstChildNamed(path[i]);
    		if (elt == null)
    			return null;
    	}
    	return elt;
