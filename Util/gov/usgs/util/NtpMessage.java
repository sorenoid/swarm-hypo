...
public class NtpMessage
{
	 ...
	 * @param array bytes to make message from
	 */
	 ...
	 * @return array of bytes from packet
	 */
	 ...
	 * format.
	 * @param array place to store message
	 * @param pointer offset in array to store message
	 * @return message as a double
	 */
	 ...
	 * @param array place to store timestamp
	 * @param pointer offset in array to store timestamp
	 * @param timestamp to be stored in array
	 */
	 ...
	 * @param timestamp time to encode
	 ...
	 * @param stratum 
	 * @param version
	 * @return string representation of reference parameter
	 */
