...
public class LineRenderer implements Renderer
{
	...
	public static final Stroke TICK_STROKE = new BasicStroke(
			1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 10.0f,
    ...
    public void render(Graphics2D g)
    {
        ...
        if (color != null)
            g.setColor(color);
    	if (line != null && !(Double.isNaN(line.x1) || Double.isNaN(line.x2) || Double.isNaN(line.y1) || Double.isNaN(line.y2)))
            g.draw(line);
